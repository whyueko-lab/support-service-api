...
<head>
    ...
    <style>
        * {
        ...
        /* --- VARIANT WARNA TIAP CARD (PREMIUM PASTEL) --- */
        
        /* 1. Card Primary / Blue (Contoh: Total Tiket) */
        .card-primary {
            background: #f0f6ff;
            border-color: #dbeafe;
        }
        ...
        /* 2. Card Success / Green (Contoh: Tiket Selesai) */
        .card-success {
            background: #f0fdf4;
            border-color: #dcfce7;
        }
        ...
        /* 3. Card Warning / Orange-Yellow (Contoh: Pending) */
        .card-warning {
            background: #fffbeb;
            border-color: #fef3c7;
        }
        ...
        /* 4. Card Danger / Red (Contoh: High Priority / Urgent) */
        .card-danger {
            background: #fef2f2;
            border-color: #fee2e2;
        }
