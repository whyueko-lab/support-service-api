...
<head>
    ...
    <style>
        * {
        ...
        /* Badge kecil untuk jumlah notifikasi belum dibaca di sidebar */
        .sidebar-badge {
            margin-left: auto;
            background: #ef4444;
            color: #ffffff;
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="/dashboard/notifications" class="<?= ($seg_2 === 'notifications') ? 'active' : '' ?>">
                ...
                <?php if (($notifikasiTiketBaru ?? 0) > 0) : ?>
                    <span class="sidebar-badge" title="Tiket baru belum dibaca">
                        <?= $notifikasiTiketBaru ?>
                    </span>
                <?php endif; ?>
            </a>
