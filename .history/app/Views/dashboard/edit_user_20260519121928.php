...
<div class="form-container">
    ...
    <form action="/dashboard/users/update/<?= esc($user['id_user']) ?>" method="post">
        <div class="form-grid">
            ...
            <!-- Password Baru (Full-Width di baris bawah agar seimbang) -->
            <div class="form-group" style="grid-column: span 2;">
                <label>Password Baru (Opsional)</label>
                <div class="input-group">
                    <i class="uil uil-key-skeleton input-icon"></i>
                    <input type="password" id="password" name="password" placeholder="Isi hanya jika ingin mengganti password lama">
