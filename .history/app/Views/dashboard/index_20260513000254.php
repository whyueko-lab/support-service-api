...
<div class="container">
    ...
    <a href="/dashboard/ratings" style="display:inline-block;padding:10px 15px;background:#4b5563;color:white;text-decoration:none;border-radius:8px;margin-left:8px;">
    Lihat Rating
    </a>

    <a href="/dashboard/reports/sla" style="display:inline-block;padding:10px 15px;background:#6b7280;color:white;text-decoration:none;border-radius:8px;margin-left:8px;">
    Laporan KPI/SLA
    </a>
</div>
