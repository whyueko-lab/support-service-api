...
<style>
    ...
    .btn-delete {
        ...
        align-items: center;
        gap: 8px;
        margin-left: auto; /* Mendorong tombol delete ke ujung kanan */
    }
...
<div class="form-container">
    ...
    <form action="/dashboard/users/update/<?= esc($user['id_user']) ?>" method="post">
        <div class="form-grid">
            ...
            <a href="/dashboard/users/delete/<?= esc($user['id_user']) ?>" class="btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini? Tindakan ini tidak dapat dibatalkan.');">
                <i class="uil uil-trash-alt"></i> Hapus User
            </a>
        </div>
    </form>
</div>
