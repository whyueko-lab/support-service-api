    ...
    <div class="responsive-table-wrapper">
        <table>
            ...
            <tbody>
                <?php if (!empty($notifications)) : ?>
                    <?php foreach ($notifications as $n) : ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                    $tipe = $n['tipe_notifikasi'] ?? 'umum';
                                    $tipeLabel = str_replace('_', ' ', $tipe);
                                ?>

                                <span class="badge-type <?= esc($tipe) ?>">
                                    <?= esc($tipeLabel) ?>
                                </span>
                            </td>
                ...
                <?php else : ?>
                    <tr>
                        <td colspan="10" style="text-align: center; color: #94a3b8; padding: 48px 0;">
