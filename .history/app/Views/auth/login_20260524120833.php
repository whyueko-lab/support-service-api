...
<head>
    ...
    <title>Login Admin - Smart Ticketing System</title>
    ...
    <style>
        * {
        ...
        body {
            /* Menggabungkan gambar latar belakang dengan gradien mesh modern */
        ...
        /* Aksen garis gradien atas yang lebih halus */
        .login-card::before {
            content: '';
            position: absolute;
            top: 0;
        ...
        /* Perubahan warna ikon saat input aktif */
        ...
        /* Desain Alert Error Glassmorphism Merah */
        .alert {
            padding: 12px 16px;
            border-radius: 14px;
        ...
        /* Gaya teks pendaftaran (Baru ditambahkan) */
        .register-container {
            text-align: center;
            margin-top: 24px;
            font-size: 14px;
    ...
    <div class="login-card">
        <div class="brand-header">
            <div class="brand-logo">
                <img src="/assets/img/logo_support.png" alt="Logo Support Service" width="24" height="24">
            </div>
