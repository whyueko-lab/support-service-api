        ...
        <form action="/register/process" method="post">
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="nama" placeholder="Nama Lengkap Admin" value="<?= old('nama') ?>" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="email" name="email" placeholder="admin@support.com" value="<?= old('email') ?>" required>
                </div>
            </div>
