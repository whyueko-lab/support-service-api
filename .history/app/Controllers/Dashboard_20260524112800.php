...
class Dashboard extends BaseController
{
    ...
    public function downloadSlaReportPdf()
    {
        ...
        $overdueAktif = $applyDateFilter(new \App\Models\TicketModel())
            ->where('status', 'overdue')
            ->countAllResults();
        ...
        $totalNilai = 0;
            ...
            $overdueAktifTeknisiQuery = new \App\Models\TicketModel();
...
$lateDoneTeknisiQuery = new \App\Models\TicketModel();
