...
class NaiveBayesClassifier
{
    ...
    public function predict(array $words): array
    {
        ...
        foreach ($scores as $item) {
            // Batasi selisih agar tidak terlalu negatif (mencegah underflow PHP menjadi 0)
        ...
        // Hitung confidence ratio
        $confidence = ($totalExp > 0) ? (exp(0) / $totalExp) : 0;
        $confidencePercent = round($confidence * 100, 2);

        // Jika kata benar-benar baru/kosong, berikan fallback 100% ke kategori tertinggi
